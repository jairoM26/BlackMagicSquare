...
diabolic(A,B):- diabolicA(A), print([A]),diabolicB(L),reflection(L,B).
diabolic(A,B,C):- diabolic(A,B),diabolicA(L),rotation_center(L,C).
diabolic(A,B,C,D):-diabolic(A,B,C),diabolicA(L),rotation_columns(L,D).
diabolic(A,B,C,D,E):-diabolic(A,B,C,D),diabolicA(L),rotation_rows(L,E).
diabolic(A,B,C,D,E,F):-diabolic(A,B,C,D,E),diabolicA(L),convolution(L,F).

diabolic(A,B,C,D,E,F,G):-diabolic(A,B,C,D,E,F),diabolicB(L),reflection(L,G).
diabolic(A,B,C,D,E,F,G,H):-diabolic(A,B,C,D,E,F,G),diabolicB(L),rotation_center(L,H).
diabolic(A,B,C,D,E,F,G,H,I):-diabolic(A,B,C,D,E,F,G,H),diabolicC(L),rotation_columns(L,I).
diabolic(A,B,C,D,E,F,G,H,I,J):-diabolic(A,B,C,D,E,F,G,H,I),diabolicC(L),rotation_rows(L,J).
...
reflection([A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P],X):-
    append([D,C,B,A,H,G,F,E],[L,K,J,I,P,O,N,M],X),
    print([X]),
    diabolic(X).  
...
rotation_center([A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P],X):-
    append([A,E,H,D,B,F,G,C],[N,J,K,O,M,I,L,P],X),
    diabolic(X),
    print([X]).  
...
rotation_columns([A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P],X):-
    append([D,A,B,C,H,E,F,G],[L,I,J,K,P,M,N,O],X),
    diabolic(X),
    print([X]).
...
rotation_rows([A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P],X):-
    append([E,F,G,H,I,J,K,L],[M,N,O,P,A,B,C,D],X),
    diabolic(X),
    print([X]).
    
%----------Convolution-----------------------
%Take the rows and converts it in a 2x2 square.
convolution([A,B,C,D,E,F,G,H,I,J,K,L,M,N,O,P],X):-
    append([A,D,H,E,B,C,G,F],[N,O,K,J,M,P,L,I],X),
    diabolic(X),
    print([X]).
...
append([],L,L).
append([X|Xs],L,[X|Temp]) :- append(Xs,L,Temp).
